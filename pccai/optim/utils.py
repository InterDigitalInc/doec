...
from pccai.optim.cd_crm import CDLossCRM
from pccai.optim.mse_crm import MSELossCRM
from pccai.optim.ce_sparse import SparseCrossEntropyLoss
...
loss_classes = {
    ...
    'cd_crm': CDLossCRM,
    'mse_crm': MSELossCRM,
    'ce_sparse': SparseCrossEntropyLoss,
}
