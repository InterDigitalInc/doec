...
from pccai.models.modules.octree_coder import DeepOctreeEntropyCoder, DeepOctVoxelContextEntropyCoder
from pccai.models.modules.entropycoders import BaseEntropyCoder, VoxelContextEntropyCoder
...
def get_module_class(module_name, hetero=False):
    ...
    module_dict = {
        ...
        'doctvxlcntxtec': [DeepOctVoxelContextEntropyCoder, None],
        'baseentropycoder': [BaseEntropyCoder, None],
        'voxelcontextentropycoder': [VoxelContextEntropyCoder, None],
    }
